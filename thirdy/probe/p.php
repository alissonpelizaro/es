...
ob_start();
//date_default_timezone_set('America/Sao_Paulo');//Time zone setting
$title = 'PHP Probe';
...
<link href="../../my/assets/icons/font-awesome/css/font-awesome.min.css" rel="stylesheet">
...
<body>
<a name="w_top"></a>
<div id="nav" style="background: #1976C9">
    <div style="display: inline-block">
        <div class="w_logo"><span></span></div>
    </div>
    <div style="margin: -48px auto 0 auto; width: 770px; height: 45px;">
    <div style="display: inline-block;">
        <a class="w_top" onclick="$('body,html').animate({ scrollTop: 0 }, 200);"><i class="fa fa-tasks"></i> Informações do servidor</a>
        <a class="w_top" onclick="$('body,html').animate({ scrollTop: $('#w_php').offset().top }, 200);"><i class="fa fa-tags"></i> Parâmetros PHP</a>
        <a class="w_top" onclick="$('body,html').animate({ scrollTop: $('#w_module').offset().top }, 200);"><i class="fa fa-cogs"></i> Componentes</a>
...
<table style="border-radius: 5px;">
  <tr><th colspan="4" style="background:#1976C9; color: white"><i class="fa fa-tasks"></i> Parâmetros do servidor</th></tr>
  <tr>
...
<?if("show"==$sysReShow){?>
<table>
  <tr><th colspan="6" style="background:#1976C9; color: white"><i class="fa fa-area-chart"></i> Dados do servidor em tempo real</th></tr>
...
<table>
    <tr><th colspan="5" style="background:#1976C9; color: white"><i class="fa fa-bar-chart"></i> Rede</th></tr>
...
<table width="100%" cellpadding="3" cellspacing="0" align="center">
  <tr>
    <th colspan="4"  style="background:#1976C9; color: white"><i class="fa fa-download "></i> Módulos PHP</th>
  </tr>
  <tr>
...
<table>
  <tr><th colspan="4" style="background:#1976C9; color: white"><i class="fa fa-tags"></i> Parâmetros PHP</th></tr>
  <tr>
...
<table>
  <tr><th colspan="4"  style="background:#1976C9; color: white"><i class="fa fa-cogs"></i> Componentes</th></tr>
...
<table>
  <tr><th colspan="4"  style="background:#1976C9; color: white"><i class="fa fa-cubes"></i> Componentes de terceiros</th></tr>
  <tr>
...
<!--Database support -->
<table>
  <tr><th colspan="4"  style="background:#1976C9; color: white"><i class="fa fa-database"></i> Banco de dados</th></tr>
...
<table>
  <tr><th colspan="5" style="background:#1976C9; color: white"><i class="fa fa-tachometer"></i> Testes de performance do servidor</th></tr>
...
<!-- Network speed test-->
<table>
    <tr><th colspan="3"  style="background:#1976C9; color: white"><i class="fa fa-cloud-upload"></i> Teste de velocidade da internet</th></tr>
  <tr>
    <td width="19%" align="center"><input name="act" type="submit" target="_blank" class="btn" value="Testar" />
    <br />
...
<table>
  <tr><th colspan="3"  style="background:#1976C9; color: white"><i class="fa fa-link"></i> Conexão com MySQL</th></tr>
...
<table>
  ...
  <tr><th colspan="3"  style="background:#1976C9; color: white"><i class="fa fa-code"></i> Testar função</th></tr>
...
<!--Mail Send Test-->
<table>
  <tr><th colspan="3" style="background:#1976C9; color: white"><i class="fa fa-envelope-o "></i> Testar envio de e-mail</th></tr>
  <tr>
    <td width="15%"></td>
    <td width="70%">
