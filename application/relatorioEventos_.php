		...
		<tbody>
			...
			foreach ($dadosTabela["dadosTabela"] as $linha){
				/* if ($linha['acao'] != "Logou no sistema" && $linha['acao'] != "Saiu do sistema" &&
						...
						$linha['acao'] != "Saiu da fila" && $linha['acao'] != "Saiu na fila" &&
						$linha['acao'] != "Transbordo de fila" && $linha['acao'] != "Transbordou atendimento" &&
						$linha['acao'] != "Logou no sistema" && $linha['acao'] != "Logou no sistema" && 
						$linha['acao'] != "Recebeu transbordo" ){
