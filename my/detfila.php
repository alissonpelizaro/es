                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-12">
                              <input type="text" 
                              		 ...
                              		 required 
                              		 name="nome" 
                              		 value="<?php echo $fila['nomeFila'] ?>" 
                              		 id="inNome" 
                              		 placeholder="Nome"
                              		 <?php if($_SESSION['tipo'] != 'dev'){ echo "readonly";}?>>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                          ...
                          <div class="form-group text-center">
                            ...
                            <div>
                              <div class="form-check form-check-inline"  style="padding-left: 10px;">
                                <input class="form-check-input" type="checkbox" <?php if($fila['status'] == 1){ echo "checked"; } ?> name="status" id="checkboxStatus" value="1" <?php if($_SESSION['tipo'] != 'dev'){ echo "disabled";}?>>
                              	<?php if($_SESSION['tipo'] != 'dev'){?><input name="statusH" hidden="true" value="<?php if($fila['status'] == 1){ echo 1; }else{ echo 0; }?>"/><?php }?>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="form-group text-center">
                            ...
                            <div>
                              <div class="form-check form-check-inline"  style="padding-left: 10px;">
                                <input class="form-check-input" type="checkbox" <?php if($fila['statusProtocolo'] == 1){ echo "checked"; } ?> name="statusProtocolo" id="checkboxStatusProtocolo" value="1" <?php if($_SESSION['tipo'] != 'dev'){ echo "disabled";}?>>
                              	<?php if($_SESSION['tipo'] != 'dev'){?><input name="statusProtocoloH" hidden="true" value="<?php if($fila['statusProtocolo'] == 1){ echo 1; }else{ echo 0; }?>"/><?php }?>
                              </div>
                            </div>
                          </div>
                        </div>
