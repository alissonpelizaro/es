                      ...
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <div class="input-group input-group-default">
                            ...
                            <select class="js-select form-control" id="filas" multiple="multiple" style="width: 345px" onchange="slectAgsDasFilas();">
...
function slectAgsDasFilas(){
	$.ajax({
 		method: "POST",
 		url: "../application/relatorioEventos.php",
 		data: {
 		 	origem: 'requisicaoAgentes',
     	filas: $("#filas").val()
    },
    success: function(result){
      if(result != 'false'){
