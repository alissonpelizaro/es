                      ...
                      <div class="row">
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="text" value="" id="dataini" name="dataini" class="form-control datepicker-here" data-language='pt' data-position="bottom left" placeholder="Data de início" autocomplete="off">
                          </div>
                        </div>
                        <div class="col-sm-1 form-group clockpicker">
								          <label class="control-label junta">Hora inícial</label>
								          <input type='text' class="form-control" name="horaIni" id="inHoraIni" placeholder="00:00" autocomplete="off">
								        </div>
                        <div class="col-md-2">
                          <div class="form-group has-danger">
                            <label class="control-label junta">Data final</label>
                            <input type="text" value="" id="datafim" name="datafim" class="form-control datepicker-here" data-language='pt' data-position="bottom left" placeholder="Data final" autocomplete="off">
                          </div>
                        </div>
                        <div class="col-sm-1 form-group clockpicker">
								          <label class="control-label junta">Hora final</label>
								          <input type='text' class="form-control" name="horaFim" id="inHoraFim" placeholder="00:00" autocomplete="off">
								        </div>
                        <div class="col-md-3">
                          <div class="form-group">
