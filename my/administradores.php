<?php
include '../application/administradores.php';
  ...
  <div class="page-wrapper">
    ...
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h3 class="padrao">Administradores</h3>
      </div>
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                ...
                <?php if($licenca->validaLicencaAdministrador()){ ?>
                  <span>
              ...
              <div class="table-responsive m-t-10">
                <?php if(!$users){
                  ...
                  <hr>
                  <center>
                    <h3 class="text-muted"><i>Nenhum administrador cadastrado.</i></h3>
                  </center>
                  <?php
                } else { ?>
...
$(document).ready(function() {
  ...
  <?php if(isset($_GET['cadastro']) && $_GET['cadastro'] == 'success'){
    ?>
    swal("Opa, tudo certo!", "Um novo administrador foi cadastrado!", "success")
    <?php
  } ?>
  <?php if(isset($_GET['edicao']) && $_GET['edicao'] == 'success'){
    ?>
    swal("Feito!", "As informações do administrador foram atualizadas!", "success")
    <?php
  } ?>

  <?php if(isset($_GET['action']) && $_GET['action'] == 'trashed' && isset($_GET['status']) && $_GET['status'] == 'success'){
    ?>
    swal("Feito!", "O administrador foi excluído!", "success")
    <?php
  } ?>
});
</script>
