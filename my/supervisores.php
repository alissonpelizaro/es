<?php
include '../application/supervisores.php';
  ...
  <div class="page-wrapper">
    ...
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h3 class="padrao">Supervisores</h3>
      </div>
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">
                ...
                <?php if($licenca->validaLicencaSupervisor()){ ?>
                  <span>
              ...
              <div class="table-responsive m-t-10">
                <?php if(!$users){
                  ...
                  <hr>
                  <center>
                    <h3 class="text-muted"><i>Nenhum supervisor cadastrado.</i></h3>
                  </center>
                  <?php
                } else { ?>
...
$(document).ready(function() {
  ...
  <?php if(isset($_GET['cadastro']) && $_GET['cadastro'] == 'success'){
    ?>
    swal("Opa, tudo certo!", "Um novo supervisor foi cadastrado!", "success")
    <?php
  } ?>
  <?php if(isset($_GET['edicao']) && $_GET['edicao'] == 'success'){
    ?>
    swal("Feito!", "As informações do supervisor foram atualizadas!", "success")
    <?php
  } ?>

  <?php if(isset($_GET['action']) && $_GET['action'] == 'trashed' && isset($_GET['status']) && $_GET['status'] == 'success'){
    ?>
    swal("Feito!", "O supervisor foi excluído!", "success")
    <?php
  } ?>
});
</script>
