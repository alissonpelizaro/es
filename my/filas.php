								...
								<table id="tabelaLogE"
									...
									<tbody>
                                        ...
                                        <tr>
    										...
    										<td>
                                			<?php if ($fl['valid'] == 'yes') {?>
                                  				<span class="label label-rouded label-success">Ativo</span>
                                      		<?php } else if ($fl['valid'] == 'no') {?>
                                  				<span class="label label-rouded label-danger">Inativo</span>
                                  			<?php } else {?>
                                  				<span class="label label-rouded label-warning">Testando</span>
                                  			<?php }?>
                              				</td>
    										<td><?php echo dataBdParaHtml($fl['dataCadastro']) ?></td>
    										<td>
								...
								<div class="col-sm-6">
									<div class="form-check form-check-inline"
										...
										<input class="form-check-input" type="checkbox"
											name="statusProtocolo" id="checkboxStatusProtocolo" value="1">
									</div>
								</div>
							</div>
						</div>
