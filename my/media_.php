						...
						<div class="row">
							<div class="col-12">
								<div class="">
									...
									<div class="recent-comment box-contatos box-atendimentos"	id="listaAtendimentos"></div>
								</div>
							</div>
						</div>
						<div class="row">
									...
									<div class="card-body">
										<?php if (! $setted) {
											...
											<div class="box-chat">
												<div class="box-chat-header">
													...
													if ($cliente ['foto'] != "" && $cliente ['foto'] != NULL) {
														?><div class="avatar-chat">
															<img
															src="assets/medias/clients/<?php echo $cliente['foto'] ?>">
														</div>
														<?php
													} else {
														?>
														<img
														src="assets/icons/social/<?php echo $at->plataforma ?>.png">
														<?php
													}
													?>
												</div>
												<div class="name-chat">
													...
													<div class="dropdown btn-trash" style="margin-top: 30px;">
														...
														class="fa fa-paperclip" aria-hidden="true"></span></span>
														<span class="btn btn-secondary btn-sm btn-outline"
													...
													data-target="#modalFinalizaAtendimento" hidden="true"></button>
												</div>
										...
										<div class="box-chat-footer">
											<form class="enterness">
												<div class="row">
													<div class="col-10">
														<textarea class="textarea_editor" name="msg" autofocus id="textareaChat" placeholder="Digite..." onkeydown="areaEnvia(this, event);"></textarea>
														<span class="botoes-textarea">
															<ul>
																<li onclick="selecionaTexto('negrito')"><i class="fa fa-bold" aria-hidden="true"></i></li>
																<li onclick="selecionaTexto('italico')"><i class="fa fa-italic" aria-hidden="true"></i></li>
																<li onclick="selecionaTexto('riscado')"><i class="fa fa-strikethrough" aria-hidden="true"></i></li>
															</ul>
														</span>
													</div>
									...
									<div class="row">
										...
										<div class="col-5">
											<div class="form-group m-0">
												...
												<div class="">
													<input value="<?php echo $cliente["fone"];?>"
													type="tel" class="form-control" name="fone"
													id="inFone" placeholder="Telefone">
												</div>
											</div>
										</div>
									</div>
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="form-group" id="divModalTranfAgente" hidden='true'>
				...
				?>
			</select> <i><b>Atenção!</b> O agente de destino verá todo
				o seu histórico de conversa com esse cliente.</i>
			</div>
							...
							if(Array.isArray(cookies[0])){
								cookies.forEach(function(cookieEach){
									if($("#idCliente").val() == cookieEach[0]){
										...
										$("#inFone").val(cookieEach[4]);
										$("#inCpf").val(cookieEach[5]);
										$("#inPromocoes").val(cookieEach[6]);
										$("#inRua").val(cookieEach[7]);
										$("#inBairro").val(cookieEach[8]);
										$("#inNumResi").val(cookieEach[9]);
										$("#inCep").val(cookieEach[10]);
										$("#estado").val(cookieEach[11]);
										$("#inComplemento").val(cookieEach[12]);
										$("#inCidade").val(cookieEach[13]);
										$("#inClienteEmpresa").val(cookieEach[14]);
									}
								});
							} else {
								if($("#idCliente").val() == cookies[0]){
									...
									$("#inFone").val(cookies[4]);
									$("#inCpf").val(cookies[5]);
									$("#inPromocoes").val(cookies[6]);
									$("#inRua").val(cookies[7]);
									$("#inBairro").val(cookies[8]);
									$("#inNumResi").val(cookies[9]);
									$("#inCep").val(cookies[10]);
									$("#estado").val(cookies[11]);
									$("#inComplemento").val(cookies[12]);
									$("#inCidade").val(cookies[13]);
									$("#inClienteEmpresa").val(cookies[14]);
								}
							}
						}
						<?php }?>
